...
10.times do 
  event = Event.create!(start_date: Faker::Date.forward(23), duration: rand(1..15) * 5, title:Faker::Esport.event , description: Faker::PrincessBride.quote, price:Faker::Number.decimal(3), location:Faker::Dune.planet, administrator_id: rand(User.first.id..User.last.id))
end 
